...
class WfcImpl {
    ...
    onUserInfoUpdate(userIds) {
        console.log('onUserInfoUpdate',userIds)
        if (!self.isLogined) {
            return;
        }
    ...
    getUserInfos(userIds, groupId = '') {
        ...
        console.log('getUserInfos',userInfoStrs)
